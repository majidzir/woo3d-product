...
<model-viewer id="woo3d-model" class="" alt="مدل سه بعدی" ar ar-modes="scene-viewer webxr quick-look" ar-scale="fixed" interaction-prompt="auto" camera-controls touch-action="pan-y" auto-rotate src="<?php echo $url3d; ?>" shadow-intensity="2" skybox-height="2m">
    ...
    <button id="btn-full" class="btn3d btnfullshort ">
    ...
    <button id="btn-fullexit" class="btn3d btnfullshort  hidden3d">
        <svg width="1.5rem" height="1.5rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
            <g id="SVGRepo_iconCarrier">
